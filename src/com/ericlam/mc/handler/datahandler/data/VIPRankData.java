...
public class VIPRankData implements DataHandler {
    ...
    private HashMap<OfflinePlayer, String> groups = new HashMap<>();
    ...
    public void loadDatas() {
        ...
        for (OfflinePlayer viper : vipers) {
            ...
            String group = permission.getPrimaryGroup(Bukkit.getWorlds().get(0).getName(), viper);
    ...
    public HashMap<OfflinePlayer, String> getGroups() {
        return groups;
    }
}
